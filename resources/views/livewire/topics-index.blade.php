    ...
    <div>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Areas of
                            Law</span>
                    </div>
                </li>
            </ol>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg pt-5">
            <div class="pb-4 pt-5 mr-4 bg-white dark:bg-gray-900">
                ...
                <div class="flex d-flex justify-end"> <a href="{{ route('admin.topics.create') }}" wire:navigate
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <span style="background-color: #74CC86"></span>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($topics as $topic)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('admin.categories.edit', $topic->id) }}" wire:navigate
